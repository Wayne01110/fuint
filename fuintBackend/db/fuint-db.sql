...
CREATE TABLE `mt_message` (
  ...
  `STATUS` char(1) DEFAULT 'A' COMMENT '状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='系统消息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=12830 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';
