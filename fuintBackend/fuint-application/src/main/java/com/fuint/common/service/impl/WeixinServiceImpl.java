...
import static com.fuint.common.util.WxImageUploadUtil.connectHttpsByPost;
...
//                 memberCard.put("background_pic_url", baseImage + wxCardDto.getBackgroundUrl());
            ...
            baseInfo.put("custom_app_brand_user_name", "gh_5cd1496a2645@app");
            baseInfo.put("custom_app_brand_pass", "pages/user/index");
            baseInfo.put("promotion_app_brand_user_name", "gh_5cd1496a2645@app");
            baseInfo.put("promotion_app_brand_pass", "pages/user/index");
            // 自定义居中使用入口小程序页面地址
            baseInfo.put("center_app_brand_user_name", "gh_5cd1496a2645@app");
            baseInfo.put("center_app_brand_pass", "pages/user/index");
